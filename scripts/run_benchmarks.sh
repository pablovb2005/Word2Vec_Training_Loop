...
PYTHONPATH=src python -m word2vec --corpus "${CORPUS_PATH}" --benchmark-profile large-stream --benchmark-repeats 2 --benchmark-json artifacts/benchmark_large_stream.json --benchmark-markdown artifacts/benchmark_large_stream.md --queries "word,vectors,tiny,context"
